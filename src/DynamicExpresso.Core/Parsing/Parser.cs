...
namespace DynamicExpresso.Parsing
{
    ...
    {
        public static Expression Parse(ParserArguments arguments, CultureInfo parseCultureInfo = null)
        {
            if (parseCultureInfo != null)
                ParseCulture = parseCultureInfo;
        ...
        private Expression Parse()
        {
            ...
            ValidateToken(TokenId.End, TranslateExtension.TranslateText("SyntaxError", ParseCulture));
            return expr;
        }
        ...
        private Expression ParseConditional()
        {
            ...
            if (_token.id == TokenId.Question)
            {
                ...
                ValidateToken(TokenId.Colon, TranslateExtension.TranslateText("ColonExpected", ParseCulture));
                NextToken();
        ...
        private Expression ParseTypeTesting()
        {
                    ...
                    || _token.text == ParserConstants.KeywordAs)
            {
                ...
                if (!_arguments.TryGetKnownType(_token.text, out knownType))
                    throw CreateParseException(op.pos, TranslateExtension.TranslateText("TypeIdentifierExpected", ParseCulture));
                ...
                if (typeOperator == ParserConstants.KeywordIs)
                    ...
                    throw CreateParseException(_token.pos, TranslateExtension.TranslateText("SyntaxError", ParseCulture));
            ...
            while (true)
            {
                ...
                else if (_token.id == TokenId.OpenParen)
                {
                    ...
                    if (typeof(Delegate).IsAssignableFrom(expr.Type))
                        ...
                        throw CreateParseException(tokenPos, TranslateExtension.TranslateText("InvalidMethodCall", ParseCulture), GetTypeName(expr.Type));
                }
                else
                {
                    break;
        ...
        private Expression ParsePrimaryStart()
        {
            switch (_token.id)
            {
                ...
                default:
                    throw CreateParseException(_token.pos, TranslateExtension.TranslateText("ExpressionExpected", ParseCulture));
            }
        }
        ...
        private Expression ParseCharLiteral()
        {
            ...
            if (s.Length != 1)
                throw CreateParseException(_token.pos, TranslateExtension.TranslateText("InvalidCharacterLiteral", ParseCulture));
            ...
            for (int i = 0; i < source.Length; i++)
            {
                ...
                if (c == '\\')
                {
                    if ((i + 1) == source.Length)
                        throw CreateParseException(_token.pos, TranslateExtension.TranslateText("InvalidEscapeSequence", ParseCulture));
        ...
        private Expression ParseIntegerLiteral()
        {
            ...
            if (text[0] != '-')
            {
                if (!ulong.TryParse(text, ParseLiteralUnsignedNumberStyle, ParseCulture, out ulong value))
                    throw CreateParseException(_token.pos, TranslateExtension.TranslateText("InvalidIntegerLiteral", ParseCulture), text);
        ...
        private Expression ParseRealLiteral()
        {
            ...
            if (value == null)
                throw CreateParseException(_token.pos, TranslateExtension.TranslateText("InvalidRealLiteral", ParseCulture), text);
        ...
        {
            ValidateToken(TokenId.OpenParen, TranslateExtension.TranslateText("OpenParenExpected", ParseCulture));
            NextToken();
            Expression innerParenthesesExpression = ParseExpressionSegment();
            ValidateToken(TokenId.CloseParen, TranslateExtension.TranslateText("CloseParenOrOperatorExpected", ParseCulture));
        ...
        private Expression ParseTypeof()
        {
            ...
            if (args.Length != 1)
                throw CreateParseException(errorPos, TranslateExtension.TranslateText("TypeofRequiresOneArg", ParseCulture));

            var constExp = args[0] as ConstantExpression;
            if (constExp == null || !(constExp.Value is Type))
                throw CreateParseException(errorPos, TranslateExtension.TranslateText("TypeofRequiresAType", ParseCulture));
        ...
        private Expression GenerateConditional(Expression test, Expression expr1, Expression expr2, int errorPos)
        {
            if (test.Type != typeof(bool))
                throw CreateParseException(errorPos, TranslateExtension.TranslateText("FirstExprMustBeBool", ParseCulture));
            if (expr1.Type != expr2.Type)
            {
                ...
                else
                {
                    ...
                    if (expr1As2 != null)
                        throw CreateParseException(errorPos, TranslateExtension.TranslateText("BothTypesConvertToOther", ParseCulture), type1, type2);

                    throw CreateParseException(errorPos, TranslateExtension.TranslateText("NeitherTypeConvertsToOther", ParseCulture), type1, type2);
                }
            }
        ...
        {
            NextToken();
            ValidateToken(TokenId.Identifier, TranslateExtension.TranslateText("IdentifierExpected", ParseCulture));
            ...
            if (constructor == null)
                throw CreateParseException(_token.pos, TranslateExtension.TranslateText("NoApplicableConstructor", ParseCulture), newType);
        ...
        private Expression ParseLambdaInvocation(LambdaExpression lambda, int errorPos)
        {
            ...
            if (!PrepareDelegateInvoke(lambda.Type, ref args))
                throw CreateParseException(errorPos, TranslateExtension.TranslateText("ArgsIncompatibleWithLambda", ParseCulture));
        ...
        private Expression ParseDelegateInvocation(Expression delegateExp, int errorPos)
        {
            ...
            if (!PrepareDelegateInvoke(delegateExp.Type, ref args))
                throw CreateParseException(errorPos, TranslateExtension.TranslateText("ArgsIncompatibleWithDelegate", ParseCulture));
        ...
        private Expression ParseTypeKeyword(Type type)
        {
            ...
            if (_token.id == TokenId.Question)
            {
                if (!type.IsValueType || IsNullableType(type))
                    throw CreateParseException(errorPos, TranslateExtension.TranslateText("TypeHasNoNullableForm", ParseCulture), GetTypeName(type));
            ...
            ValidateToken(TokenId.Dot, TranslateExtension.TranslateText("DotOrOpenParenExpected", ParseCulture));
            NextToken();
        ...
        private Expression GenerateConversion(Expression expr, Type type, int errorPos)
        {
            ...
            {
                throw CreateParseException(errorPos, TranslateExtension.TranslateText("CannotConvertValue", ParseCulture),
        ...
        private Expression GeneratePropertyOrFieldExpression(Type type, Expression instance, int errorPos, string propertyOrFieldName)
        {
            ...
            throw CreateParseException(errorPos, TranslateExtension.TranslateText("UnknownPropertyOrField", ParseCulture), propertyOrFieldName, GetTypeName(type));
        }
        ...
        private Expression ParseExtensionMethodInvocation(Type type, Expression instance, int errorPos, string id, Expression[] args)
        {
            ...
            if (extensionMethods.Length > 1)
                throw CreateParseException(errorPos, TranslateExtension.TranslateText("AmbiguousMethodInvocation", ParseCulture), id, GetTypeName(type));
        ...
        private Expression[] ParseArgumentList()
        {
            ...
            ValidateToken(TokenId.CloseParen, TranslateExtension.TranslateText("CloseParenOrCommaExpected", ParseCulture));
            NextToken();
            return args;
        }
        ...
        {
            var errorPos = _token.pos;
            ValidateToken(TokenId.OpenBracket, TranslateExtension.TranslateText("OpenParenExpected", ParseCulture));
            NextToken();
            var args = ParseArguments();
            ValidateToken(TokenId.CloseBracket, TranslateExtension.TranslateText("CloseBracketOrCommaExpected", ParseCulture));
            NextToken();
            if (expr.Type.IsArray)
            {
                if (expr.Type.GetArrayRank() != 1 || args.Length != 1)
                    throw CreateParseException(errorPos, TranslateExtension.TranslateText("CannotIndexMultiDimArray", ParseCulture));
                var index = PromoteExpression(args[0], typeof(int), true);
                if (index == null)
                    throw CreateParseException(errorPos, TranslateExtension.TranslateText("InvalidIndex", ParseCulture));
            ...
            {
                throw CreateParseException(errorPos, TranslateExtension.TranslateText("NoApplicableIndexer", ParseCulture),
                        GetTypeName(expr.Type));
            }

            if (applicableMethods.Length > 1)
            {
                throw CreateParseException(errorPos, TranslateExtension.TranslateText("AmbiguousIndexerInvocation", ParseCulture),
                        GetTypeName(expr.Type));
            }
        ...
        private void NextToken()
        {
            ...
            switch (_parseChar)
            {
                ...
                case '&':
                    ...
                    {
                        throw CreateParseException(_parsePosition, TranslateExtension.TranslateText("InvalidCharacter", ParseCulture), _parseChar);
                    }
                    break;
                case '(':
                    NextChar();
                ...
                case '"':
                    ...
                    if (_parsePosition == _expressionTextLength)
                        throw CreateParseException(_parsePosition, TranslateExtension.TranslateText("UnterminatedStringLiteral", ParseCulture));
        ...
        {
            if (!char.IsDigit(_parseChar))
                throw CreateParseException(_parsePosition, TranslateExtension.TranslateText("DigitExpected", ParseCulture));
        }
