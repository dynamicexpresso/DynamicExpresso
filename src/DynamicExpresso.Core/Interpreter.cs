...
namespace DynamicExpresso
{
    ...
    public class Interpreter
    {
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public Lambda Parse(string expressionText, CultureInfo cultureInfo = null, params Parameter[] parameters)
        {
            return Parse(expressionText, typeof(void), cultureInfo, parameters);
        }
        ...
        public Lambda Parse(string expressionText, Type expressionType, CultureInfo cultureInfo = null, params Parameter[] parameters)
        {
            return ParseAsLambda(expressionText, expressionType, parameters, cultureInfo);
        }

        [Obsolete("Use ParseAsDelegate<TDelegate>(string, params string[])")]
        public TDelegate Parse<TDelegate>(string expressionText, CultureInfo cultureInfo = null, params string[] parametersNames)
        {
            return ParseAsDelegate<TDelegate>(expressionText, cultureInfo, parametersNames);
        }
        ...
        public TDelegate ParseAsDelegate<TDelegate>(string expressionText, CultureInfo cultureInfo = null, params string[] parametersNames)
        {
            var lambda = ParseAs<TDelegate>(expressionText, cultureInfo, parametersNames);
            return lambda.Compile<TDelegate>();
        }
        ...
        public Expression<TDelegate> ParseAsExpression<TDelegate>(string expressionText, CultureInfo cultureInfo = null, params string[] parametersNames)
        {
            var lambda = ParseAs<TDelegate>(expressionText, cultureInfo, parametersNames);
            return lambda.LambdaExpression<TDelegate>();
        }
        ...
        public Lambda ParseAs<TDelegate>(string expressionText, CultureInfo cultureInfo = null, params string[] parametersNames)
        {
            var delegateInfo = ReflectionExtensions.GetDelegateInfo(typeof(TDelegate), parametersNames);

            return ParseAsLambda(expressionText, delegateInfo.ReturnType, delegateInfo.Parameters, cultureInfo);
        }
        #endregion
        ...
        public object Eval(string expressionText, CultureInfo cultureInfo = null, params Parameter[] parameters)
        {
            return Eval(expressionText, typeof(void), cultureInfo, parameters);
        }
        ...
        public T Eval<T>(string expressionText, CultureInfo cultureInfo = null, params Parameter[] parameters)
        {
            return (T)Eval(expressionText, typeof(T), cultureInfo, parameters);
        }
        ...
        public object Eval(string expressionText, Type expressionType, CultureInfo cultureInfo = null, params Parameter[] parameters)
        {
            return Parse(expressionText, expressionType, cultureInfo, parameters).Invoke(parameters);
        }
        #endregion
        ...
        private Lambda ParseAsLambda(string expressionText, Type expressionType, Parameter[] parameters, CultureInfo cultureInfo = null)
        {
            ...
            var expression = Parser.Parse(arguments, cultureInfo);
